...
2. Criar um novo projeto Java Maven no NetBeans ou executar o comando:
...
mvn package
java -jar ./target/expr-parser-1.0-SNAPSHOT-jar-with-dependencies.jar ~/Desktop/exemplo.txt
```
...
9. Executar o código `mvn generate-sources`, depois criar uma classe Calculador
